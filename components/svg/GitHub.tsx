function GitHub({width, height, color}: { width: number, height: number, color: string }) {
    return (
        <svg width={`${width}px`} height={`${height}px`} strokeWidth="1" viewBox="0 0 24 24" fill="none"
            ...
            <path
                ...
                stroke={color} strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"></path>
            <path d="M9.66667 17.7018C7.66667 18.3335 6 17.7018 5 15.7544" stroke={color} strokeWidth="1"
